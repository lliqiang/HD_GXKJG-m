...
public class SwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		if (ta != null) {
			...
			autoAdjustTextPosition = ta.getBoolean(com.kyleduo.switchbutton.R.styleable.SwitchButton_kswAutoAdjustTextPosition, autoAdjustTextPosition);
			ta.recycle();
		}
		...
		if (mTintColor == 0) {
			...
			boolean found = getContext().getTheme().resolveAttribute(com.kyleduo.switchbutton.R.attr.colorAccent, typedValue, true);
			if (found) {
