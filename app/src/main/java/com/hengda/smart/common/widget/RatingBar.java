...
public class RatingBar extends FrameLayout implements View.OnClickListener {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                mFillDrawable = context.getDrawable(R.drawable.start);
                mEmptyDrawable = context.getDrawable(R.drawable.ic_star_chk);
            } else {
                mFillDrawable = context.getResources().getDrawable(R.drawable.start);
                mEmptyDrawable = context.getResources().getDrawable(R.drawable.ic_star_chk);
            }
        } else {
            ...
            if (mFillDrawable == null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    mFillDrawable = context.getResources().getDrawable(R.drawable.ic_star_chk);
                }
            }
