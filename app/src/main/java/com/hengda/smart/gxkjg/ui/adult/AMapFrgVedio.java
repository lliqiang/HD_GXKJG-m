 ...
 * 描述：
 */
public class AMapFrgVedio extends BaseFragment {
    ...
    public static AMapFrgVedio newInstance(int floor) {
        AMapFrgVedio fragment = new AMapFrgVedio();
