...
public class ThemeAcChild extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhild_theme);
            ...
            public void onNext(List<AcInfo> acInfos) {
                ...
                Collections.sort(acInfoList, new Comparator<AcInfo>() {
                    ...
                    public int compare(AcInfo acInfo, AcInfo t1) {
                        ...
                        lvTheme.setAdapter(adapter=new LCommonAdapter<AcInfo>(ThemeAcChild.this,R.layout.lv_item_theme,acInfoList) {
                    @Override
                        ...
                        if (acInfo!=null){
                           topLast= holder.getView(R.id.latest);
                            ...
                            holder.getConvertView().setOnClickListener(v ->{
                                Intent intent=new Intent(ThemeAcChild.this, QringAc.class);
